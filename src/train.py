...
from utils import log_losses, save_generated_images, calculate_metrics, display_metrics


def save_checkpoint(generator, discriminator, epoch, optimizer_g, optimizer_d, checkpoint_dir="/content/UW/src/checkpoints"):
...
def train():
    ...
    for epoch in range(num_epochs):
        ...
        for i, (real_imgs, target_imgs) in enumerate(dataloader):
            ...
            # Save generated image for each iteration
            torchvision.utils.save_image(fake_imgs, f"/content/UW/outputs/epoch_{epoch}_iter_{i}.png")
